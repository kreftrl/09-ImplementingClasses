...
class Point(object):
    ...
    def move_to(self,newx,newy):
        ...
        self.distancetraveled=self.distancetraveled+math.sqrt((self.origx-self.x)**2+(self.origy-self.y)**2)
    ...
    def get_distance_from_start(self):
        distancefromstart=math.sqrt((self.x-self.startx)**2+(self.y-self.starty)**2)
    ...
    def closer_to(self,point2,point3):
        distance1=self.get_distance_from(point2)
        distance2=self.get_distance_from(point3)
    ...
    def halfway_to(self,point2):
        halfwaypoint=Point((self.x+point2.x)/2.0,(self.y+point2.y)/2.0)
        return halfwaypoint
